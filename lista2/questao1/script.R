...
cat(sprintf("\\newcommand{\\UMxQuatro}{%.3f\\xspace}\n", x4), file = out)
cat(sprintf("\\newcommand{\\UMxOito}{%.3f\\xspace}\n", x8), file = out)
cat(sprintf("\\newcommand{\\UMxDezesseis}{%.3f\\xspace}\n", x16), file = out)
cat(sprintf("\\newcommand{\\UMxTrinta}{%.3f\\xspace}\n", x30), file = out)
cat(sprintf("\\newcommand{\\UMxCem}{%.3f\\xspace}\n", x100), file = out)

cat(sprintf("\\newcommand{\\UMsdQuatro}{%.3f\\xspace}\n", sd4), file = out)
cat(sprintf("\\newcommand{\\UMsdOito}{%.3f\\xspace}\n", sd8), file = out)
cat(sprintf("\\newcommand{\\UMsdDezesseis}{%.3f\\xspace}\n", sd16), file = out)
cat(sprintf("\\newcommand{\\UMsdTrinta}{%.3f\\xspace}\n", sd30), file = out)
cat(sprintf("\\newcommand{\\UMsdCem}{%.3f\\xspace}\n", sd100), file = out)

cat(sprintf("\\newcommand{\\UMsdeQuatro}{%.3f\\xspace}\n", sde4), file = out)
cat(sprintf("\\newcommand{\\UMsdeOito}{%.3f\\xspace}\n", sde8), file = out)
cat(sprintf("\\newcommand{\\UMsdeDezesseis}{%.3f\\xspace}\n", sde16), file = out)
cat(sprintf("\\newcommand{\\UMsdeTrinta}{%.3f\\xspace}\n", sde30), file = out)
cat(sprintf("\\newcommand{\\UMsdeCem}{%.3f\\xspace}\n", sde100), file = out)
