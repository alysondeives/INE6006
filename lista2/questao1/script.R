...
h<-hist(m100, breaks=12, density=20, col="darkgray", xlab="Média Amostral da Renda", ylab="Frequência", main="",freq=TRUE,xpd=TRUE,axes=FALSE,cex.lab=1.5)
...
h<-hist(m30, breaks=12, density=20, col="darkgray", xlab="Média Amostral da Renda", ylab = "Frequência", main="",freq=TRUE,xpd=TRUE,ylim=c(0,40),axes=FALSE,cex.lab=1.5) 
...
h<-hist(m16, breaks=12, density=20, col="darkgray", xlab="Média Amostral da Renda", ylab="Frequência",main="",freq=TRUE,xpd=TRUE,ylim=c(0,50),axes=FALSE,cex.lab=1.5 ) 
...
h<-hist(m8, breaks=12, density=20, col="darkgray", xlab="Média Amostral da Renda", ylab="Frequência", main="",freq=TRUE, xpd=TRUE, ylim=c(0,55),axes=FALSE,cex.lab=1.5) 
...
h<-hist(m4, breaks=12, density=20, col="darkgray", xlab="Média Amostral da Renda", ylab="Frequência",main="",freq=TRUE, xpd=TRUE,ylim=c(0,75),axes=FALSE,cex.lab=1.5) 
