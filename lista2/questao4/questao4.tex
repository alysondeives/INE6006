...
\subsection{Precisão}
	...
	Combinando \eqref{equation: erro amostral maximo} e \eqref{equation: tamanho amostral maximo} e
	...
	erro de 2\%. Usando \eqref{equation: tamanho amostra 1} obtemos o valor de $n_0$ 
	...
	\eqref{eq:quatro-b-n-result} aplicando \eqref{equation: tamanho amostra 2}.
...
\subsection{Tamanho da amostra sem amostra piloto}
	...
	ser utilizada a fórmula \eqref{equation: tamanho amostra 1} para obtenção de
	...
	\eqref{equation: tamanho amostra 2}, resultando no tamanho da amostra necessário, em
