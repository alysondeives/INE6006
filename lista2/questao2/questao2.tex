...
\label{sub:1a}
    ...
    \todo[inline] {Porque foi dito que o desvio padrão da população é desconhecido, sendo que o valor pode ser calculado? No enunciado do trabalho é dito que a base de 5000 alunos é a população}
