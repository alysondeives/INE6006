...
\begin{minipage}{0.49\textwidth}
	...
	\captionof{figure}{Histograma da variável \textit{Renda}.}
...
\begin{minipage}{0.49\textwidth}
	...
	\captionof{figure}{\textit{Boxplot} da variável \textit{Renda}.}
	\label{figure:histograma-boxplot-renda}
\end{minipage}
\end{figure}
...
\begin{figure}[!h]
	\centering
	\includegraphics[scale=0.75]{plots/stacked_opiniao_por_regiao.eps}
...
\begin{figure}[!h]
	\centering
	\includegraphics[scale=0.75]{plots/stacked_opiniao_por_area.eps}
...
\scriptsize
\centering
\caption{Relação entre as variáveis \textit{Área} e \textit{Pagamento} usando valores absolutos}
...
\scriptsize
\centering
\caption{Relação entre as variáveis \textit{Área} e \textit{Pagamento} usando valores relativos}
