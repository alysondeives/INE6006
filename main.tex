...
\begin{table}
	\small
	\caption{Fontes de pagamento para regiões em valores absolutos.}
	\label{tabela:avaliação-por-pagamento-absoluto}
	\vspace{0.5em}
	\begin{tabular}{l r r r r r}
		\toprule
		\textbf{Fonte Pagamento}     & \textbf{Muito Insatifeito}     & \textbf{Insatisfeito}   & \textbf{Indiferente}  & \textbf{Satisfeto} & \textbf{Muito Satisfeito}  \\
		\midrule
