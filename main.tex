...
A avaliação dos alunos para cada uma das fontes de pagamento é apresentada em termos absolutos e percentuais na Tabela ?? e na Tabela ??, respectivamente. Adicionalmente, dados da Tabela ?? são apresentados em formato gráfico na Figura ??.

Analisando a amostra, não é possível afirmar que os alunos que recebem auxílio de alguém para pagar as mensalidades não são tão críticas da EAD quanto os demais. Os alunos que recebem incentivos federais são os mais críticos, $29,77\%$ estão muito insatisfeitos e $35,15\%$ estão insatisfeitos. Por outro lado, os alunos que recebem Auxílio de Familiares ou Bolsa de Estudo são menos críticos, visto que, dos que recebem bolsa, $38,72\%$ são indiferentes e $22,87\%$ estão satisfeitos; e $36,96\%$ dos que recebem auxilio dos familiares são indiferentes e $30,35\%$ estão satisfeitos.
...
\begin{table}
	\small
	\caption{Avaliação dos alunos pela fonte de pagamento. Valores percentuais\protect\footnote{Valores perdidos não são apresentados, mas são contabilizados no cálculo da porcentagem.}.}
