...
\subsection*{Dados Perdidos}
\label{subsection: dados perdidos}
...
Medidas de síntese para a variável \textit{Renda} são apresentadas na Tabela \ref{table: medidas sintese renda}. Além disso, um histograma da variável renda é apresentado na Figura \ref{figure:histograma-boxplot-renda}. Vale ressaltar que, para fins de estudo, aplicou-se uma transformação nessa variável, utilizando como fator multiplicativo o valor de $R\$880$ (referência salarial em Pindorama). 
...
\todo[inline]{Ajustar o eixo do gráfico da Figura \ref{fig:stacked-opiniao-por-regiao}.}

\clearpage
\FloatBarrier
\subsection*{Opinião por Curso}
...
\FloatBarrier
\subsection*{Pagamento por Região}
...
\FloatBarrier
\subsection*{Opinião por Pagamento}
...
Uma análise que poderia ser feita é a relação entre \textbf{Renda}, \textbf{Área} e \textbf{Opinião}. Assim seria possível complementar a questões 10 verificando se a área com alunos mais 
insatisfeitos está relacionada com os mais abastados.

Uma segunda análise seria a relação \textbf{Área} e \textbf{Pagamento}. Essa análise permite avaliar a opinião dos alunos  de acordo com sua área e forma de pagamento. Em outras palavras, seria 
...
Com a análise das Tabelas \ref{tab:q20a1} e \ref{tab:q20a2} é possível observar que na área da \textbf{Administração} os alunos mais abastados são mais insatisfeitos (44,44\%), seguido por 
indiferentes (37,04\%). Os intermediários são mais satisfeitos (46,71\%) e muito satisfeitos (33,54\%) e os pobres muito satisfeitos (92,53\%) e satisfeitos (7,05\%).
...
A área da \textbf{Engenharia e Produção} apresenta índices de insatisfeitos (44,38\%) e indiferentes (29,97\%) para os abastados, satisfeitos (36,02\%) e indiferentes (34,81\%) para os intermediários 
e muito satisfeitos (82,67\%) e satisfeitos (16,67\%) para os pobres.
...
Ao analisar as Tabelas \ref{tab:q20a1} e \ref{tab:q20a2}, pode-se inferir que os alunos de classes mais pobres são mais satisfeitos e muito satisfeitos. Já os abastados são mais insatisfeitos e os 
intermediários a opinião varia de acordo com o curso.
...
(43,94\%), seguida por incentivos federais (29,11\%) e recursos próprios (15,22\%), ficando com os menores índices as bolsas de estudos (6,55\%) e auxílio de familiares (5,18\%). Essas informações 
também podem ser analisadas na Figura \ref{fig:q20b}
...
maiores índices dos alunos que utilizam essa forma de pagamento, conforme apresentada na Tabela 18, é muito satisfeito (66,09\%) e satisfeito (22,68\%). Essa análise pode ser confirmada com a Tabela 
14, pois os alunos das áreas \textbf{Educacional} (89,91\%), \textbf{Humanidades} (74,90\%) e \textbf{Administração} (56,37\%) possuem maiores níveis de satisfação.   

Os alunos da área \textbf{Jurídica e Contábil}, predominantemente (57,12\%), pagam suas mensalidades com incentivos federais. Conforme apresentado na Tabela 14, os alunos da área 
\textbf{Jurídica e Contábil} são mais insatisfeitos (30,17\%) e muito insatisfeitos (26,45\%). Os resultados da Tabela 17 mostram que os alunos que pagam suas mensalidades com incentivos federais são 
...
\textbf{Jurídica e Contábil} (12,85\%) e \textbf{Humanidades} (12,15\%). A análise da Tabela 17 mostra que os alunos que pagam suas mensalidades com esta forma de pagamento são mais indiferentes 
...
(6,42\%), \textbf{Administração} (4,75\%), \textbf{Humanidades} (2,19\%) e \textbf{Educacional} (1,48\%). Segundo a análise da Tabela 17 alunos que pagam suas mensalidades com essa forma de pagamento 
...
(5,07\%), \textbf{Humanidades} (3,39\%), \textbf{Administração} (3,05\%) e \textbf{Educacional} (0,89\%). A Tabela 17 aponta que alunos que pagam suas mensalidades com essa forma de pagamento são 
