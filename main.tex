...
\begin{figure}[h]
	\centering
	\includegraphics[scale=0.75]{plots/stacked_opiniao_por_pagamento.eps}
	\caption{Avaliação dos alunos pela fonte de pagamento}
...
\footnotesize
\centering
\caption{Avaliações para alunos pagantes e não-pagantes. Valores percentuais.}
...
\begin{figure}[!h]
	\centering
	\includegraphics[scale=0.65]{plots/stacked_opiniao_por_faixaRenda.eps}
