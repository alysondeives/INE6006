...
A tabela frequências para a variável \textit{Região} é apresentada na Tabela \ref{table: frequencias regiao}. Os resultados indicam que as regiões com menor e maior número de alunos são as regiões \textit{\baep} e \textit{\para}, respectivamente. Já as demais regiões apresentam um corpo discente que varia de $10.77\%$ a $23.80\%$.
