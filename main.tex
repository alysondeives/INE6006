...
\begin{figure}[!h]
	\centering
	\includegraphics[]{plots/stacked_opiniao_por_area.eps}
...
\centering
\small
\caption{Satisfação percentual de alunos de acordo com classes de renda.}
...
\midrule
%                & M Insatsf.      & Insats.         & Indif.          & Satisf.         & Muito Satisf.    & Total         \\ 
	Pobres         & $0\%$     & $0\%$     & $0.48\%$  & $8.18\%$  & $91.34\%$ & \textbf{100\%} \\
	Intermediário  & $0.49\%$  & $9.63\%$  & $31.31\%$ & $35.84\%$ & $22.73\%$ & \textbf{100\%} \\
 	Abastados      & $36.86\%$ & $40.87\%$ & $17.79\%$ & $3.53\%$  & $0.96\%$  & \textbf{100,01\%} \\
\midrule
  \textbf{Total} & $\textbf{37,35\%}$    & $\textbf{50,5\%}$    & $\textbf{49,58\%}$   & $\textbf{47,55\%}$   & $\textbf{115,03\%}$    & $\textbf{??}$ \\
\bottomrule
\end{tabular}
\end{table}
...
As áreas que utilizam predominantemente a forma de pagamento por Financiamento Bancário é a Educacional (91.72\%), seguida pela Humanidades (78.09\%) e Administração 
(67.97\%), ficando com índices mais baixos as áreas Computação e Matemática (54.73\%), Engenharia e Produção (39.41\%) e Jurídica e Contábil (15.45\%). Já a opinião com 
...
\ref{table:opiniao-por-area}, pois os alunos das áreas Educacional (89.91\%), Humanidades (74.90\%) e Administração (56.37\%) possuem maiores níveis de satisfação.

Os alunos da área Jurídica e Contábil, predominantemente (57.12\%), pagam suas mensalidades com recursos de Incentivos Federais. Conforme apresentado na Tabela \ref{table:opiniao-por-area}, os alunos da área 
Jurídica e Contábil estão mais insatisfeitos (30.17\%) e muito insatisfeitos (26.45\%). Os resultados da Tabela \ref{table: avaliacao por fonte de pagamento} mostram que os alunos que pagam suas mensalidades com incentivos federais são 
...
os alunos da área Jurídica e Contábil são mais insatisfeitos.

Já a forma de pagamento por recursos próprios tem predominância nas áreas Computação e Matemática (21.28\%), Engenharia e Produção (19.56\%), Administração (14.07\%), 
Jurídica e Contábil (12.85\%) e Humanidades (12.15\%). A análise da Tabela \ref{table: avaliacao por fonte de pagamento} mostra que os alunos que pagam suas mensalidades com esta forma de pagamento são mais indiferentes 
(31.40\%) e satisfeitos (21.90\%). 

A forma de pagamento com bolsa de estudo apresenta com predominância nas áreas Jurídica e Contábil (8.52\%), Engenharia e Produção (7.73\%), Computação e Matemática 
(6.42\%), Administração (4.75\%), Humanidades (2.19\%) e Educacional (1.48\%). Segundo a análise da Tabela \ref{table: avaliacao por fonte de pagamento} alunos que pagam suas mensalidades com essa forma de pagamento 
são mais indiferentes (38.72\%) e satisfeitos (22.87\%).

Por fim, a forma de pagamento por auxílio de familiares é predominante para as áreas Engenharia e Produção (6.52\%), Jurídica e Contábil (6.06\%), Computação e Matemática 
(5.07\%), Humanidades (3.39\%), Administração (3.05\%) e Educacional (0.89\%). A Tabela \ref{table: avaliacao por fonte de pagamento} aponta ainda que alunos que pagam suas mensalidades com essa forma de pagamento são 
