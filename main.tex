...
\begin{figure}[!h]
	\centering
	\includegraphics[width=0.7\linewidth]{plots/stacked_opiniao_por_regiao.eps}
...
\begin{figure}[!h]
	\centering
	\includegraphics[width=0.70\linewidth]{plots/stacked_opiniao_por_area.eps}
...
\begin{figure}[!h]
	\centering
	\includegraphics[width=0.70\linewidth]{plots/stacked100_pagamento_por_regiao.eps}
...
\begin{figure}[!h]
	\centering
	\includegraphics[width=0.70\linewidth]{plots/stacked_pagamento_por_regiao.eps}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.70\linewidth]{plots/stacked_opiniao_por_pagamento.eps}
...
\small
\centering
\caption{Avaliações para alunos nas categorias agrupadas de pagantes e não-pagantes. Valores percentuais.}
