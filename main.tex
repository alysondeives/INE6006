...
%Conforme a tabela X, pode-se observar que os alunos que recebem incentivos federais são mais críticos (29,77% estão muito insatisfeitos e 35,15% estão insatisfeitos). 
Por outro lado, os alunos que recebem Auxílio de Familiares ou Bolsa de Estudo são menos críticos (visto que 38,72% dos que recebem bolsa são indiferentes e 22,87% dos que recebem bolsa estão satisfeitos, enquanto 36,96% dos que recebem auxilio dos familiares são indiferentes e 30,35% dos que recebem o auxilio de familiares estão satisfeitos).
