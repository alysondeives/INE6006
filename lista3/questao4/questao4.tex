...
\label{questao:4b}
	...
	\todo[inline]{oder do teste é $1-\beta$ e não $\beta$}
	\todo[inline]{A discussão deve ser feita no sentido de explicar o que
	significa um poder do teste $x$ com proporção $y$. Usar os valores
