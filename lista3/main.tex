...
\usepackage{minted} %melhor que listings, compilar com -shell-escape, requer pygmentize (pygments) instalado

%%%%%%%%%%%% Configuring packages
% Minted \setminted onyly in minted >= 2.0
%\setminted{breaklines,linenos}

%\autoref deve fazer coisas do tipo Questão 1, Item 2.b
\addto\extrasbrazil{%
  \renewcommand{\sectionautorefname}{Questão}
...
% Numeração de seções e subseções consistente com questões e itens
...
% Atalho para \mintinline{r}|...|
% minted < 2.0 não tem mintinline
%\def\r|#1|{\mintinline{r}|#1|}
\def\r|#1|{\texttt{#1}}
\newcommand{\inputr}[1]{\inputminted[linenos]{r}{#1}}
