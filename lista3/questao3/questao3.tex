...
Para obter o tamanho da amostra foi utilizado o software R e o seguinte comando:

\todo[inline]{Pendente}

\inputminted{r}{questao3/b.R}


\subsection{Tamanho mínimo de amostra}
\label{questao:3c}
A mesma função, do ambiente R, usada no \autoref{questao:3b} pode ser ser utilizada para calcular o tamanho mínimo da amostra: 

\inputminted{r}{questao3/c.R}

Como resultado, foram obtidos os dados apresentados pela \autoref{tb:3c}. 
Como o tamanho de amostra encontrado pela função não é um inteiro ($2177.447$), é necessário efetuar um arredondamento para cima, obtendo $2178$.
